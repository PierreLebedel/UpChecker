...
class EndpointPolicy
{
    ...
    {
        return $user->can('view', $endpoint->project);
    }
    ...
    {
        return $user->can('update', $endpoint->project);
    }
    ...
    {
        return $user->can('delete', $endpoint->project);
    }
    ...
    {
        return $user->can('restore', $endpoint->project);
    }
    ...
    {
        return $user->can('forceDelete', $endpoint->project);
    }
}
