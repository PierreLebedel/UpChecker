...
class CheckupPolicy
{
    ...
    {
        return $user->can('view', $checkup->endpoint);
    }
    ...
    {
        return $user->can('delete', $checkup->endpoint);
    }
    ...
    {
        return $user->can('restore', $checkup->endpoint);
    }
    ...
    {
        return $user->can('forceDelete', $checkup->endpoint);
    }
}
